package cn.bs.zjzc.pulltorefresh.impl;
...
import cn.bs.zjzc.pulltorefresh.HeaderLoadingLayout;
import cn.bs.zjzc.pulltorefresh.ILoadingLayout;
import cn.bs.zjzc.pulltorefresh.LoadingLayout;
import cn.bs.zjzc.pulltorefresh.PullToRefreshBase4SwipeMenu;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshSwipeListView extends PullToRefreshBase4SwipeMenu<SwipeMenuListView> implements OnScrollListener {
    ...
    public void setCanLoadEnabled(boolean canLoadEnabled){
        setPullLoadEnabled(canLoadEnabled);
    }
    ...
    /**
     * 无数据加载的时候添加相应的footView提示用户无更多数据了。
     */
    @Override
